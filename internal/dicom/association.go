...
func (a *Association) Snapshot() AssociationSnapshot {
	a.mu.Lock()
	defer a.mu.Unlock()
	return AssociationSnapshot{ID: a.ID, CallingAET: a.CallingAET, CalledAET: a.CalledAET, State: a.State, AcceptedSyntaxes: append([]string(nil), a.AcceptedSyntaxes...), LastActivity: a.LastActivity, MaxPDU: a.MaxPDU}
}
